...
document.addEventListener('DOMContentLoaded', function () {
	...
	if (mainSlider) {
		let mainSliderThumbs = new Swiper('.main_slider .btns .swiper', {
			loop: false,
			speed: 500,
		...
		new Swiper('.main_slider .swiper.main', {
			loop: true,
			speed: 750,
			watchSlidesProgress: true,
			slideActiveClass: 'active',
	...
	// Page head - Links
	let pageHeadLinks = document.querySelector('.page_head .links')
	...
	// Mob. menu
	$('header .menu_btn, .sidebar_menu .close_btn, .overlay').click(e => {
		e.preventDefault()
...
function initMap() {
	ymaps.ready(() => {
		...
		// Кастомный маркер
		let myPlacemark = new ymaps.Placemark([59.848809, 30.322327], {}, {
